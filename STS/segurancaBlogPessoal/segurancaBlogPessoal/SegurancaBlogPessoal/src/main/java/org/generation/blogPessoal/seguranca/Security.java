...
@Configuration // --> Anotação para configuração de métodos BEAN pelo spring
@EnableWebSecurity // --> Aotação que permite extender os métodos do WebSecurityConfigurerAdapter
